...
@Component({
    ...
    standalone: true,
    imports: [CommonModule, FormsModule, ToolbarModule, ButtonModule, DatePickerModule, TableModule, TagModule, SelectModule, InputTextModule, ProgressSpinnerModule, MessageModule, DialogModule],
    template: `
        <div class="card">
            ...
            <!-- Preview Dialog -->
            <p-dialog [(visible)]="showPreview" [header]="'Preview Calibration Form'" [modal]="true" [style]="{ width: '90vw', height: '90vh' }" [maximizable]="true">
                <div class="preview-container" style="max-height: 70vh; overflow-y: auto;">
                    ...
                    <div style="background: white; padding: 30px; font-family: Arial, sans-serif; line-height: 1.5;">
                        ...
                        <!-- Title -->
                        <div style="text-align: center; font-size: 16px; font-weight: bold; margin: 20px 0;">CALIBRATION FORM</div>
...
export class CalibrationReportComponent implements OnInit {
    ...
    private proceedWithPreviewDownload(): void {
        ...
        const documentContent = `
            ...
            <html>
                ...
                <body>
                    ...
                    <!-- Title -->
                    <div class="title">CALIBRATION FORM</div>
        ...
        const filename = `calibration-${this.reportType}-${timestamp}.doc`;
